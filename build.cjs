...
<header class="nav">
  <div class="container nav__inner">
    ...
    <div class="nav__cta">
      <a href="tel:+${PHONE_TEL}" class="btn btn--gold btn--sm">📞 <span dir="ltr">${PHONE_DISPLAY}</span></a>
  ...
  <div class="container">
    <div class="footer__grid">
      <div>
        ...
        <p style="margin-top:14px"><a href="tel:+${PHONE_TEL}" style="color:var(--gold);font-weight:800;font-size:1.05rem">📞 <span dir="ltr">+965 ${PHONE_DISPLAY}</span></a></p>
      </div>
      <div>
        <h4>خدماتنا</h4>
        <ul>
      ...
      <div>
        <h4>تواصل مباشر</h4>
        <ul>
          <li><a href="tel:+${PHONE_TEL}">📞 <span dir="ltr">+965 ${PHONE_DISPLAY}</span></a></li>
...
<div class="mobile-bar">
  <a class="mb-call" href="tel:+${PHONE_TEL}">📞 اتصل · <span dir="ltr">${PHONE_DISPLAY}</span></a>
...
<section class="section">
  <div class="container">
    <div class="cta-banner reveal">
      ...
      <div class="cta-banner__actions"><a href="tel:+${PHONE_TEL}" class="btn btn--gold">📞 <span dir="ltr">${PHONE_DISPLAY}</span></a><a href="https://wa.me/${WA}" class="btn btn--ghost" style="color:#fff;border-color:rgba(255,255,255,.2)">واتساب</a></div>
    </div>
  </div>
</section>
</main>
    ...
    <div class="about">
      <div class="reveal">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:28px">
          <a href="tel:+${PHONE_TEL}" class="btn btn--primary">📞 اتصل · <span dir="ltr">${PHONE_DISPLAY}</span></a>
...
<section class="section">
  <div class="container">
    ...
    <div class="cta-banner reveal" style="margin-top:48px">
      ...
      <div class="cta-banner__actions"><a href="tel:+${PHONE_TEL}" class="btn btn--gold">📞 <span dir="ltr">${PHONE_DISPLAY}</span></a></div>
    </div>
  </div>
</section>
</main>
  ...
  <div class="container">
    ...
    <div class="contact">
      <div class="contact__info reveal">
        <div class="contact__row"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.13.96.37 1.9.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.7A2 2 0 0122 16.92z"/></svg><div><b>اتصل بنا مباشرة</b><a href="tel:+${PHONE_TEL}" style="color:var(--gold);font-weight:800;font-size:1.15rem"><span dir="ltr">+965 ${PHONE_DISPLAY}</span></a><br><span>24 ساعة طوال أيام الأسبوع</span></div></div>
